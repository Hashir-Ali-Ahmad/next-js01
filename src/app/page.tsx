...
export default function Home() {
 ...
 <div className="md:flex flex-col py-5">
  <img className="w-24 h-24 md:w-48 md:h-auto  rounded-full mx-auto" src="https://images.unsplash.com/photo-1587837073080-448bc6a2329b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fG1vZGVsJTIwbWFsZSUyMGFlc3RoZXRpY3xlbnwwfHwwfHx8MA%3D%3D" alt="" width="384" height="512"/>
  ...
  <img className="w-24 h-24  rounded-full my-auto mx-auto m-3" src="https://images.unsplash.com/photo-1587837073080-448bc6a2329b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fG1vZGVsJTIwbWFsZSUyMGFlc3RoZXRpY3xlbnwwfHwwfHx8MA%3D%3D" alt="" width="384" height="512"/>
  </div> 
